...
from .method import ForestSplats
...
def eval_few_custom(method: ForestSplats, logger: Logger, dataset: Dataset, split: str, step: int, evaluation_protocol: EvaluationProtocol):
    disable_tqdm = False
...
@click.option("--savepath", type=str, required=True)
...
def train_command(
    ...
    # Load dataset
    method_info = ForestSplats.get_method_info()
